-- ============================================================
-- book-manage 二手书买卖管理系统 数据库初始化脚本
-- 适用：MySQL 8.0+
...
CREATE TABLE trade_record (
    ...
    book_name    VARCHAR(128)   DEFAULT NULL COMMENT '书名快照',
    order_price  DECIMAL(10,2)  DEFAULT NULL COMMENT '成交价快照',
    seller_id    BIGINT         DEFAULT NULL COMMENT '卖家ID',
    seller_name  VARCHAR(50)    DEFAULT NULL COMMENT '卖家名',
    buyer_id     BIGINT         NOT NULL COMMENT '买家ID',
    buyer_name   VARCHAR(50)    DEFAULT NULL COMMENT '买家名',
    status       TINYINT        NOT NULL DEFAULT 0 COMMENT '状态 0-待确认 1-已成交 2-已取消 3-已拒绝',
